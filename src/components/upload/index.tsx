import React, {
  useMemo, useRef, useState, useCallback, ReactNode
} from "react";
...
import {
  ImgWrapper, ImgCloseBtn, ProgressListItem, ProgressLi, ImgUpload,
  ProgressListItemName, chooseProgressListColor
} from "./style"
...
/** 如果返回promise，需要提供file，否则同步需要返回boolean，如果为false，则不发送*/
// export const beforeUpload?: (f: File, i: number) => boolean | Promise<File>;
export function Upload(props: UploadProps) {
  ...
  return (
    ...
    >
      {/* {console.log('shouldShow is', shouldShow)}
      {console.log('uploadMode is', uploadMode)}
      {console.log('customBtn is', customBtn)} */}

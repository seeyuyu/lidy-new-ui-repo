import React, {
  ...
  TouchEvent, PropsWithChildren, useMemo, useEffect,
  useRef
} from 'react'
...
export function Carousel(props: PropsWithChildren<CarouselProps>) {
  const { defaultIndex, height, autoplayDelay,
    delay, children, autoplay, animationDelay,
    autoplayReverse, radioAppear, touchDiff=80, width, style,
    classname, viewportBoxshadow
  } = props;
  //设置需要展示的元素

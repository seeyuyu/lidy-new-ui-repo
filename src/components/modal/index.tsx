import React, {
  PropsWithChildren, ReactNode, useMemo, useState, useEffect, useRef, CSSProperties
} from "react";
...
export function Modal(props: PropsWithChildren<ModalProps>) {
  const { visible, maskClose, closeButton, delay, mask, container, confirm, okText, style,
    cancelText, onOk, onCancel, callback, title, parentSetState, stopScroll, portralStyle,
    refCallback, closeCallback,
  } = props;
